    ...
    <section class="main-section">
        <div class="container-listings discover-container">
            ...
            if (!isset($_SESSION['result'])) {
                $sql = "SELECT l.L_ID, l.First_Picture_Path, l.Title, l.Price, l.Location FROM listings l, users u WHERE u.U_ID = l.Seller AND u.User_Status = 'active' AND l.isHidden = '0'";
